  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="business analytics, product analytics, RevOps, SQL, Python, Snowflake, Tableau, Power BI, data visualization, business intelligence, USC Marshall"
        />
        ...
        <meta
          ...
          content="The Bridge Between Data and Impact. Expert in Product Implementation, Business Strategy, and RevOps."
        />
