...
const projects: Project[] = [
  ...
  },
  {
    ...
    status: "Shipped",
    problem:
      "Regional and global clients lacked actionable visibility into market research and consumer behavior metrics.",
    data: "Raw datasets from enterprise CRM, marketing platforms, and consumer behavior tracking systems.",
    methods:
      "Data modeling, automated ETL pipelines, interactive visualization design",
    tools: ["SQL", "Snowflake", "Tableau", "Power BI"],
    insights:
      "Transformed raw datasets into testable insights, surfacing hidden patterns in consumer behavior and market trends.",
    impact:
      "Delivered 15+ high-impact dashboards for regional and global enterprise clients.",
    impactMetric: "15+ Dashboards",
    frictionLog: [
      {
        hurdle: "Data latency of 24+ hours in legacy reporting",
        solution:
          "Migrated to Snowflake with incremental refresh, reducing latency to under 15 minutes.",
      },
      {
        hurdle: "Stakeholder misalignment on KPI definitions",
        solution:
          "Created a shared metrics glossary and automated data validation layer.",
      },
    ],
    stakeholders: [
  ...
  },
  {
    ...
    icon: Lightbulb,
    category: "fintech",
    industry: "FinTech / ERP",
    status: "Shipped",
    problem:
      "Enterprise clients experienced manual AR workflows causing delays in cash-flow reporting.",
    data: "Financial transaction data including ACH, wire, and card transactions; ERP billing and AR records.",
    methods:
      "SQL optimization, stored procedures, payment portal integrations, SaaS financial modeling",
    tools: ["SQL", "Excel (VBA)", "ERP Systems", "SaaS Platforms"],
    insights:
      "Identified bottlenecks in financial transaction processing and automated key AR workflows.",
    impact:
      "Streamlined processing by 25%, achieved 30% working capital savings across 7+ implementations.",
    impactMetric: "$2M+ Impact",
    frictionLog: [
      {
        hurdle: "Legacy ERP systems with no API access",
        solution:
          "Built custom SQL stored procedures and VBA macros for automated data extraction and reconciliation.",
      },
      {
        hurdle: "Resistance to process change from finance teams",
        solution:
          "Ran parallel processing for 2 sprints to demonstrate accuracy before full cutover.",
      },
    ],
    stakeholders: [
      { icon: DollarSign, label: "Finance" },
